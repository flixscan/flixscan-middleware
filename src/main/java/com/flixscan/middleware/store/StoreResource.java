...
public class StoreResource {
    ...
    @GET
    @Path("{id}")
    public Uni<StoreEntity> getSingleEntry(@PathParam("id") Long id) {
    ...
    public Uni<List<StoreEntity>> getEntryByPage(int limit, int  offset) {
    ...
    @PUT
    @Path("{id}")
    public Uni<Response> updateEntry(Long id, StoreEntity store) {
    ...
    public Uni<Response> deleteEntry(@PathParam("key") Long id) {
